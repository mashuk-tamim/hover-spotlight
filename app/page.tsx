...
import github from "@/public/card-01.png"
import slack from "@/public/card-02.png"
import discord from "@/public/card-03.png"

export default function Home() {
  return (
		<main className="h-[100vh] flex items-center bg-[#0f172a] px-10">
